...
<head>
    ...
    <title>Admnistrar Comunicaciones</title>
</head>
<body>
...
if($conexion_base == true) {
    $consulta_incidentes = "SELECT * FROM area_comunicaciones";
    ...
    if($mostrar_incidentes == true) {
        while($row = $mostrar_incidentes->fetch_array()) {
            ...
            ?>
                ...
                <form action="../php/administrar_comunicaciones.php" method="POST">
                <table class="table">
                    <thead>
                        <tr>
                ...
                <tr>
                    ...
                    <th class="eliminar"><button name="eliminar" type="submit"><i class="fas fa-times"></i></button></th>
                </tr>
            </tbody>
        </table>
    </form>
...
if(isset($_POST['eliminar'])) {
    $query_delete = "DELETE FROM area_comunicaciones WHERE id_incidente = '$id_incidente'";
