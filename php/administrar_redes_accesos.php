...
<head>
    ...
    <title>Admnistrar Redes y accesos</title>
</head>
<body>
...
if($conexion_base == true) {
    $consulta_incidentes = "SELECT * FROM area_redes_accesos";
    ...
    if($mostrar_incidentes == true) {
        while($row = $mostrar_incidentes->fetch_array()) {
            ...
            ?>
                ...
                <form action="../php/administrar_redes_accesos.php" method="POST">
                <table class="table">
                    <thead>
                        <tr>
...
if(isset($_POST['eliminar'])) {
    $query_delete = "DELETE FROM area_redes_accesos WHERE id_incidente = '$id_incidente'";
