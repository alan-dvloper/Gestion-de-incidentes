...
<head>
    ...
    <title>Admnistrar Base de datos</title>
</head>
<body>
...
if($conexion_base == true) {
    $consulta_incidentes = "SELECT * FROM area_database";
    ...
    if($mostrar_incidentes == true) {
        while($row = $mostrar_incidentes->fetch_array()) {
            ...
            ?>
                <form action="../php/administrar_database.php" method="POST">
                <table class="table">
                    <thead>
                        <tr>
...
if(isset($_POST['eliminar'])) {
    $query_delete = "DELETE FROM area_database WHERE id_incidente = '$id_incidente'";
