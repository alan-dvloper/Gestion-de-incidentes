...
if(empty($_POST['fecha_incidente']) || empty($_POST['descripcion_incidente'])){
    ...
    $registro_incidentes = "INSERT INTO area_software (proyecto_afectado,fecha_incidente,areas_afectadas,tipo_incidente,descripcion_incidente)
...
if(isset($_POST['btn-administrar'])) {
    header('location:../php/administrar_software.php');
}
